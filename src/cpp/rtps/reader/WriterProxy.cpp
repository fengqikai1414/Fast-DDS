...
#define SHOULD_DEBUG_LINUX !defined(NDEBUG) && defined(FASTRTPS_SOURCE) && defined(__linux__)

#if SHOULD_DEBUG_LINUX
...
constexpr size_t changes_node_size = memory_set_node_size<SequenceNumber_t>();
